...
def dispatch(
    ...
    if registry.building_key_from_text(text):
        return registry.handle_upgrade(
            chat_id, registry.building_key_from_text(text) or "purifier"
        )
